...
conky -c ~/.Conky/conky-dashboard/rings & # the main conky with rings
...
conky -c ~/.Conky/conky-dashboard/cpu &
conky -c ~/.Conky/conky-dashboard/mem &
conky -c ~/.Conky/conky-dashboard/network &
conky -c ~/.Conky/conky-dashboard/notes &
